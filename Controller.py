...
def submit():
    ...
    return ('<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">'+'<link rel="stylesheet" href="https://www.w3schools.com/lib/w3-theme-green.css">'+'<h1 class="w3-theme-l3" style="text-align: center">'+'<br>'+'<br>'+'<br>'+'<br>'+'<p class="w3-theme">'+'Your Correct Answer Score is '+correct_count+'</p>'+'<p class="w3-theme">'+'Your Incorrect Answer Score is '+incorrect_count+'</p>'+'<br>'+'<br>'+'<br>'+'<br>'+'</h1>')
